...
Feature: Contentpool media replication basically works.
  ...
  Scenario: Media attached to replicated entities is replicated
    ...
    # Add teaser to article
    And I press "field_teaser_media_entity_browser_entity_browser"
    Then I wait for AJAX to finish
    When I click on item with name "BEHAT: Media image 1" in entity browser "image_browser"
    ...
    And I press "field_teaser_media_entity_browser_entity_browser"
    Then I wait for AJAX to finish
    And I click on item with name "BEHAT: Media image 2" in entity browser "image_browser"
    And I click on "#edit-submit" in entity browser "image_browser"
    And I wait for entity browser "image_browser" to close
    Then I wait for AJAX to finish
    And I press "Save as"
  ...
  Scenario: Replication media works only for referenced media
    ...
    And I press "field_teaser_media_entity_browser_entity_browser"
    Then I wait for AJAX to finish
    When I click on item with name "BEHAT: Media image 3" in entity browser "image_browser"
    And I click on "#edit-submit" in entity browser "image_browser"
    And I wait for entity browser "image_browser" to close
    Then I wait for AJAX to finish
  ...
  Scenario: Replication of media works after media is edited
    ...
    Given I am logged in to contentpool
    When I visit path "node/add/article" on contentpool
    And I fill in "title[0][value]" with "BEHAT: Media article 3"
    And I fill in "field_seo_title[0][value]" with "Media article 3"
    And I select "-Cooking" from "edit-field-channel"
    # Add teaser
    And I press "field_teaser_media_entity_browser_entity_browser"
    Then I wait for AJAX to finish
    When I click on item with name "BEHAT: Media image 4" in entity browser "image_browser"
    And I click on "#edit-submit" in entity browser "image_browser"
    And I wait for entity browser "image_browser" to close
    Then I wait for AJAX to finish
    # Save and publish article.
    ...
    And I am on "admin/content"
    Then I should see the text "BEHAT: Media article 3"

    # Check media is replicated
    And I am on "admin/content/media"
    Then I should see the text "BEHAT: Media image 4"

    # Remove reference media BEHAT: Media image 3 and replicate
    Given I open the contentpool
    And I visit path "admin/content" on contentpool
    And I follow the "Edit" link below the element ".view-content tr:contains('BEHAT: Media article 3')"
    Then I wait for the page to be loaded
    And I press "edit-field-teaser-media-current-items-0-remove-button"
    And I wait for AJAX to finish
    Then Value of input field "[name='field_teaser_media[target_id]']" is "empty"
    ...
    And I follow the "Edit" link below the element ".view-content tr:contains('BEHAT: Media image 4')"
    Then I wait for the page to be loaded
    And I fill in "name[0][value]" with "BEHAT: Media image 4 edited"
    ...
    And I am on "admin/content/media"
    Then I should not see the text "BEHAT: Media image 4 edited"
    ...
    And I press "field_teaser_media_entity_browser_entity_browser"
    Then I wait for AJAX to finish
    When I click on item with name "BEHAT: Media image 4 edited" in entity browser "image_browser"
    And I click on "#edit-submit" in entity browser "image_browser"
    And I wait for entity browser "image_browser" to close
    Then I wait for AJAX to finish
    # Save article
    ...
    # Check media is replicated
    And I am on "admin/content/media"
    Then I should see the text "BEHAT: Media image 4 edited"
